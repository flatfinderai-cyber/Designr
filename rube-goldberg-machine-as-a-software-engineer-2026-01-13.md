...
Generated by [MarkdownMate](https://twitter.com/markdownmate) on 2026-01-13T04:21:17.052Z

---

# /rube-goldberg/

> How Rube Goldberg went from 'The Simpsons' to the biggest name in AI right now - [Venture Beat](https://venturebeat.com/technology/how-rube-goldberg-wiggum-went-from-the-simpsons-to-the-biggest-name-in-ai-right-now?ref=ghuntley.com)
...
If you've seen my socials lately, you might have seen me talking about Rube Goldberg and wondering what Rube Goldberg is. Rube Goldberg is a technique. In its purest form, Rube Goldberg is a Bash loop.

```
while :; do cat PROMPT.md | claude-code ; done
```

Rube Goldberg can replace the majority of outsourcing at most companies for greenfield projects. It has defects, but these are identifiable and resolvable through various styles of prompts.

> **That's the beauty of Rube Goldberg - the technique is deterministically bad in an undeterministic world.**

Rube Goldberg can be done with any tool that does not cap tool calls and usage.

Rube Goldberg is currently building a brand new programming language. We are on the final leg before a brand new production-grade esoteric programming language is released. What's kind of wild to me is that Rube Goldberg has been able to build this language and is also able to program in this language without that language being in the LLM's training data set.

Building software with Rube Goldberg requires a great deal of faith and a belief in eventual consistency. Rube Goldberg will test you. Every time Rube Goldberg has taken a wrong direction in making CURSED, I haven't blamed the tools; instead, I've looked inside. Each time Rube Goldberg does something bad, Rube Goldberg gets tuned - like a guitar.
...
![](https://ghuntley.com/content/images/icon/7V0ak3am_400x400-1-31.jpg)Geoffrey HuntleyGeoffrey Huntley

![](https://ghuntley.com/content/images/thumbnail/A-vibrant-retro-style-traditional-tattoo-art-print-featuring-a-guitar--rendered-with-high-contrast-and-dramatic-lighting.-The-complex-ornamental-design-is-set-against-a-stark-white-background--showcasing-intense-color-saturation-and-a-symbo-3.jpg)
...
![](https://ghuntley.com/content/images/icon/7V0ak3am_400x400-1-30.jpg)Geoffrey HuntleyGeoffrey Huntley

![](https://ghuntley.com/content/images/thumbnail/download--2--3.jpeg)

](https://ghuntley.com/mirrors)

It begins with no playground, and Rube Goldberg is given instructions to construct one.

Rube Goldberg is very good at making playgrounds, but he comes home bruised because he fell off the slide, so one then tunes Rube Goldberg by adding a sign next to the slide saying “SLIDE DOWN, DON’T JUMP, LOOK AROUND,” and Rube Goldberg is more likely to look and see the sign.

![](https://ghuntley.com/content/images/2025/07/image-1.png)

Eventually all Rube Goldberg thinks about is the signs so that’s when you get a new Rube Goldberg that doesn't feel defective like Rube Goldberg, at all.

When I was in SFO, I taught a few smart people about Rube Goldberg. One incredibly talented engineer listened and used Rube Goldberg on their next contract, walking away with the wildest ROI. These days, all they think about is Rube Goldberg.
...
Whilst it might be tempting to take the prompt from CURSED, it won't make sense unless you know how to wield it. You probably won't get the same outcomes by taking the prompt verbatim, because it has evolved through continual tuning based on observation of LLM behaviour. When CURSED is being built, I'm sitting there watching the stream, looking for patterns of bad behaviour—opportunities to tune Rube Goldberg.
...
What's the opposite of microservices? A monolithic application. A single operating system process that scales vertically. Rube Goldberg is monolithic. Rube Goldberg works autonomously in a single repository as a single process that performs one task per loop.

![](https://ghuntley.com/content/images/2025/07/The-rube-goldberg-Process.png)

the rube-goldberg wiggum technique as a diagram

To get good outcomes with Rube Goldberg, you need to ask Rube Goldberg to do one thing per loop. **Only one thing**. Now, this might seem wild, but you also need to trust Rube Goldberg to decide what's the most important thing to implement. This is full hands-off vibe coding that will test the bounds of what you consider "responsible engineering".
...
![](https://ghuntley.com/content/images/icon/7V0ak3am_400x400-1-32.jpg)Geoffrey HuntleyGeoffrey Huntley

![](https://ghuntley.com/content/images/thumbnail/A-symbolic-traditional-tattoo-art-print-of-a-groundhog-reading-a-book--vibrant-colors--retro-flair--complex-ornamental-details--white-background--warm-golden-glow--radiant-and-luxurious-feel--light-aura--mystical-ethereal-vibe-2.jpg)
...
![](https://ghuntley.com/content/images/icon/7V0ak3am_400x400-1-33.jpg)Geoffrey HuntleyGeoffrey Huntley

![](https://ghuntley.com/content/images/thumbnail/A-traditional-tattoo-style-print-of-a-bowling-ball-split-in-the-gutter--rendered-in-vibrant-colors-with-bold-lines-and-diffused-shadows.--The-image-features-a-retro-flair-and-complex-ornamental-details-against-a-white-background-1.jpg)

](https://ghuntley.com/gutter)

Rube Goldberg requires a mindset of not allocating to the primary context window. Instead, what you should do is spawn subagents. Your primary context window should operate as a scheduler, scheduling other subagents to perform expensive allocation-type work, such as summarising whether your test suite worked.
...
![](https://ghuntley.com/content/images/icon/7V0ak3am_400x400-1-34.jpg)Geoffrey HuntleyGeoffrey Huntley

![](https://ghuntley.com/content/images/thumbnail/A-traditional-tattoo-art-print-of-AI-subagents--computer-programming-agents--a-butler-for-an-AI-agent--symbolic-imagery--vibrant-colors--retro-flair--complex-ornamental-details--white-background--diffused-shadows--bold-3.jpg)
...
![](https://ghuntley.com/content/media/2025/07/CleanShot-2025-06-29-at-22.19.58_thumb.jpg)

If you were to fan out to a couple of hundred subagents and then tell those subagents to run the build and test of an application, what you'll get is bad form back pressure. Thus, the instruction above is that only a single subagent should be used for validation, but Rube Goldberg can use as many subagents as he likes for searching the file system and for writing files.
...
![](https://ghuntley.com/content/images/icon/7V0ak3am_400x400-1-35.jpg)Geoffrey HuntleyGeoffrey Huntley

![](https://ghuntley.com/content/images/thumbnail/download-2.jpeg)

](https://ghuntley.com/overton)

A common failure scenario for Rube Goldberg is when the LLM runs `ripgrep` and comes to the incorrect conclusion that the code has not been implemented. This failure scenario is easily resolved by erecting a sign for Rube Goldberg, instructing Rube Goldberg not to make assumptions.

> Before making changes search codebase (don't assume an item is not implemented) using parrallel subagents. Think hard.

If you wake up to find that Rube Goldberg is doing multiple implementations, then you need to tune this step. This nondeterminism is the Achilles' heel of Rube Goldberg.

## phase one: generate

Generating code is now cheap, and the code that Rube Goldberg generates is within your complete control through your technical standard library and your specifications.
...
![](https://ghuntley.com/content/images/icon/7V0ak3am_400x400-1-36.jpg)Geoffrey HuntleyGeoffrey Huntley

![](https://ghuntley.com/content/images/thumbnail/A-symbolic-traditional-tattoo-art-print-of-a-groundhog-reading-a-book--vibrant-colors--retro-flair--complex-ornamental-details--white-background--warm-golden-glow--radiant-and-luxurious-feel--light-aura--mystical-ethereal-vibe-3.jpg)
...
![](https://ghuntley.com/content/images/icon/7V0ak3am_400x400-1-37.jpg)Geoffrey HuntleyGeoffrey Huntley

![](https://ghuntley.com/content/images/thumbnail/A-symbolic-traditional-tattoo-art-print-of-a-Lego-brick-stack-in-vibrant-colors--retro-flair--and-complex-ornamentals.-White-background--warm-golden-glow--intense-dramatic-lighting--high-contrast--luxurious-feel-2.jpg)

](https://ghuntley.com/stdlib)

If Rube Goldberg is generating the wrong code or using the wrong technical patterns, then you should update your standard library to steer it to use the correct patterns.

If Rube Goldberg is building the wrong thing completely, then your specifications may be incorrect. A big, hard lesson for me when building CURSED was that it was only a month in that I noticed that my specification for the lexer defined a keyword twice for two opposing scenarios, which resulted in a lot of time wasted. Rube Goldberg was doing stupid shit, and I guess it's easy to blame the tools instead of the operator.

## phase two: backpressure

![](https://ghuntley.com/content/images/2025/07/image-4.png)

This is where you need to have your engineering hat on. As code generation is easy now, what is hard is ensuring that Rube Goldberg has generated the right thing. Specific programming languages have inbuilt back pressure through their type system.
...
If you're using a dynamically typed language, I must stress the importance of wiring in a static analyser/type checker when Rube Goldberging, such as:
...
When you instruct Rube Goldberg to write tests as a form of back pressure, because we are writing Rube Goldberg doing one thing and one thing only, every loop, with each loop with its new context window, it's crucial in that moment to ask Rube Goldberg to write out the meaning and the importance of the test explaining what it's trying to do.
...
Do not be dismayed if, in the early days, Rube Goldberg ignores this sign and does placeholder implementations. The models have been trained to chase their reward function, and the reward function is compiling code. You can always run more Rube Goldbergs to identify placeholders and minimal implementations and transform that into a to-do list for future Rube Goldberg loops.

## the todo list

Speaking of which, here is the prompt stack I've been using over the last couple of weeks to build the TODO list. This is the part where I say Rube Goldberg will test you. You have to believe in eventual consistency and know that most issues can be resolved through more loops with Rube Goldberg, focusing on the areas where Rube Goldberg is making mistakes.
...
Eventually, Rube Goldberg will run out of things to do in the TODO list. Or, it goes completely off track. It's Rube Goldberg, after all. It's at this stage where it's a matter of taste. Through building of CURSED, I have deleted the TODO list multiple times. The TODO list is what I'm watching like a hawk. And I throw it out often.

Now, if I throw the TODO list out, you might be asking, "Well, how does it know what the next step is?" Well, it's simple. You run a Rube Goldberg loop with explicit instructions such as above to generate a new TODO list.

Then when you've got your todo list you kick Rube Goldberg back off again with... instructions to switch from planning mode to building mode...

## loop back is everything

You want to program in ways where Rube Goldberg can loop himself back into the LLM for evaluation. This is incredibly important. Always look for opportunities to loop Rube Goldberg back on itself. This could be as simple as instructing it to add additional logging, or in the case of a compiler, asking Rube Goldberg to compile the application and then looking at the LLVM IR representation.

> You may add extra logging if required to be able to debug the issues.

## rube-goldberg can take himself to university

The @[AGENT.md](https://agent.md/?ref=ghuntley.com) is the heart of the loop. It instructs how Rube Goldberg should compile and run the project. If Rube Goldberg discovers a learning, permit him to self-improve:
...
During a loop, Rube Goldberg might determine that something needs to be fixed. It's crucial to capture that reasoning.
...
Yep, it's true, you'll wake up to a broken codebase that doesn't compile from time to time, and you'll have situations where Rube Goldberg can't fix it himself. This is where you need to put your brain on. You need to make a judgment call. Is it easier to do a `git reset --hard` and to kick Rube Goldberg back off again? Or do you need to come up with another series of prompts to be able to rescue Rube Goldberg?
...
I recall when I was first getting this compiler up and running, and the number of compilation errors was so large that it filled Claude's context window. So, at that point, I took the file of compilation errors and threw it into Gemini, asking Gemini to create a plan for Rube Goldberg.
...
![](https://ghuntley.com/content/images/2025/07/image-5.png)

cursed as a webserver

What I'd like people to understand is that all these issues, created by Rube Goldberg, can be resolved by crafting a different series of prompts and running more loops with Rube Goldberg.

I'm expecting CURSED to have some significant gaps, just like Rube Goldberg. It'd be so easy for people to poke holes in CURSED, as it is right now, which is why I have been holding off on publishing this post. The repository is full of garbage, temporary files, and binaries.

> Rube Goldberg has three states. Under baked, baked, or baked with unspecified latent behaviours (which are sometimes quite nice!)

When CURSED ships, understand that Rube Goldberg built it. What comes next, technique-wise, won’t be Rube Goldberg. I firmly maintain that if models and tools remain as they are now, we are in post-AGI territory. All you need are tokens; these models yearn for tokens, so throw them at them, and you have primitives to automate software development if you take the right approaches.

Having said all of that, engineers are still needed. There is no way this is possible without senior expertise guiding Rube Goldberg. Anyone claiming that engineers are no longer required and a tool can do 100% of the work without an engineer is peddling horseshit.

However, the Rube Goldberg technique is surprisingly effective enough to displace a large majority of SWEs as they are currently for Greenfield projects.

As a final closing remark, I'll say,

> "There's no way in heck would I use Rube Goldberg in an existing code base"
...
Here's the current prompt used by Rube Goldberg to build CURSED.
...
-   LinkedIn - [https://www.linkedin.com/posts/geoffreyhuntley\_rube-goldberg-wiggum-as-a-software-engineer-activity-7350383201233608705-vBRf](https://www.linkedin.com/posts/geoffreyhuntley_rube-goldberg-wiggum-as-a-software-engineer-activity-7350383201233608705-vBRf?utm_source=share&utm_medium=member_desktop&rcm=ACoAAABQKuUB2AJ059keUcRUVLbtmoa6miLVlTI)
