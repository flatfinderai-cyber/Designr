...
check_executable "start-rube-goldberg.sh" "Start Rube Goldberg script"
...
check_executable "scripts/setup-rube-goldberg-project.sh" "Setup Rube Goldberg project script"
...
for script in quick-start.sh start-rube-goldberg.sh download-automation.sh scripts/*.sh; do
